...
@section('content')
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="{{ route('admin.condominio.create') }}" class="btn-add">
    ...
    <div class="search-form">
        <form action="{{ route('admin.condominio.index') }}" method="GET">
            <div class="input-group">
                ...
                @if(!empty($termo))
                    <a href="{{ route('admin.condominio.index') }}" class="btn btn-outline-danger">Limpar</a>
                @endif
            </div>
        </form>
    </div>
        ...
        <table class="table table-striped mb-0">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{ route('admin.condominio.edit', $condominio->id_condominio) }}" 
                           class="btn-action btn-edit me-2">
                            <i class="fas fa-edit"></i>Editar
                        </a>
                        <form action="{{ route('admin.condominio.destroy', $condominio->id_condominio) }}" 
                              method="POST" 
                              class="d-inline"
